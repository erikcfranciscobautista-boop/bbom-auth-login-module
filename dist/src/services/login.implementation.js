import { BcpmConnectionError, BurmConnectionError, InvalidCredentialsError, } from "../errors/login.errors.js";
...
export const buildLoginUseCase = () => {
    return async (input, adapters) => {
        ...
        try {
            ...
            profileResponse = await adapters.postBurmProfilesIdentifier(input.username, input.password);
            moduleLogger.info({
                folder: "SERVICE",
                class: "LoginUseCase",
                method: "buildLoginUseCase",
        ...
        try {
            ...
            try {
                ...
                tokenResponse = await adapters.postBurmCredentialsGenerateToken(profileResponse.burmUserId, profileResponse.burmRoleId, profileResponse.burmDepartmentId, permissions);
            }
            catch (_burmGenerateTokenError) {
                moduleLogger.error({
                    folder: "SERVICE",
                    class: "LoginUseCase",
                    method: "buildLoginUseCase",
